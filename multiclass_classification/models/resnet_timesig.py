...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=4, in_channels=1, zero_init_residual=False,
...
def resnet18(num_classes=4, in_channels=1, **kwargs):
